...
// 👉 OJO: NO declares `type Props` aquí ni recibas props en la Page.
const VIDEOS: Video[] = [
  { title: 'Tecnología educativa para aprender de China', guest: 'Karina Piña', role: 'Directora', company: 'Corporación Cruzando el Pacífico', url: 'https://www.youtube.com/embed/WDoQ9IUydq8', id: 'WDoQ9IUydq8', tema: 'Tecnología & Educación' },
  { title: 'Cómo posicionar tu marca en China', guest: 'Javier Arellano', role: 'B2B2C Operation Manager', company: 'Huawei', url: 'https://www.youtube.com/embed/xyopX35IYek', id: 'xyopX35IYek', tema: 'Marca & Marketing' },
  ...
  { title: 'Hay un déficit de 45.000 programadores anuales', guest: 'Jorge Arriagada', role: 'CEO', company: 'Macrobots', url: 'https://www.youtube.com/embed/hJR-tXv6XhE', id: 'hJR-tXv6XhE', tema: 'Talento & Programación' },
  ...
  { title: 'Conversación con Juan Sutil', guest: 'Juan Sutil', role: 'Fundador', company: 'Empresas Sutil · ex presidente CPC', url: 'https://www.youtube.com/embed/S1hPuMt3Ems', id: 'S1hPuMt3Ems', tema: 'Liderazgo & Empresas' },
];
